...
decl : type  { currentType = (TS_entry)$1; } id ';'
     | DECSTRUCT { currentType = (TS_entry)$1; } id '{' { escopoLocal = new TabSimb(); } dListStruct '}' ';' { TS_entry nodo = ts.pesquisa($3);
...
idL : IDENT   { TS_entry nodo = escopoLocal.pesquisa($1);
                  ...
                  escopoLocal.insert(new TS_entry($1, currentType, currClass));
                }
         }
...
| IDENT       { TS_entry nodo = ts.pesquisa($1);
 ...
 | STRUCT IDENT { TS_entry nodo = ts.pesquisa($2);
    ...
    IDENT { TS_entry nodo = ts.pesquisa($4);
                                if (nodo != null) {
                                  yyerror("(sem) variavel >" + $4 + "< jah declarada");
                    } else {
                      ts.insert(new TS_entry($4, currentType, currClass));
                    } }
...
private TabSimb ts, escopoLocal;

public static TS_entry Tp_INT =  new TS_entry("int", null, ClasseID.TipoBase);
public static TS_entry Tp_DOUBLE = new TS_entry("double", null,  ClasseID.TipoBase);
public static TS_entry Tp_BOOL = new TS_entry("bool", null,  ClasseID.TipoBase);
public static TS_entry Tp_STRUCT = new TS_entry("decStruct", null,  ClasseID.TipoBase);
