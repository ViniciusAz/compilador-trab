...
decl : TSTRUCT { currentType = new TS_entry("?", Tp_STRUCT, currClass, $2, currentType); } 
              id '{' { localTS.push(new TabSimb()); } CorpoStruct '}' { localTS.pop(); } ';' {
...
%%
  ...
  public static TS_entry Tp_FUNCTION = new TS_entry("function", null,  ClasseID.TipoBase);
